...
namespace WindowsFormsApplication2.DataSet1TableAdapters {
    ...
    public partial class HocKyTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[HocKy] WHERE (([HocKyID] = @Original_HocKyID) AND ((@IsNull_HocKy = 1 AND [HocKy] IS NULL) OR ([HocKy] = @Original_HocKy)) AND ((@IsNull_HocPhi = 1 AND [HocPhi] IS NULL) OR ([HocPhi] = @Original_HocPhi)) AND ([TrangThai] = @Original_TrangThai))";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[HocKy] SET [HocKy] = @HocKy, [HocPhi] = @HocPhi, [TrangThai] = @TrangThai WHERE (([HocKyID] = @Original_HocKyID) AND ((@IsNull_HocKy = 1 AND [HocKy] IS NULL) OR ([HocKy] = @Original_HocKy)) AND ((@IsNull_HocPhi = 1 AND [HocPhi] IS NULL) OR ([HocPhi] = @Original_HocPhi)) AND ([TrangThai] = @Original_TrangThai));
SELECT HocKyID, HocKy, HocPhi, TrangThai FROM HocKy WHERE (HocKyID = @HocKyID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::WindowsFormsApplication2.Properties.Settings.Default.thuhocphiConnectionString;
        }
        ...
        public virtual int Fill(DataSet1.HocKyDataTable dataTable) {
        ...
        public virtual DataSet1.HocKyDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            DataSet1.HocKyDataTable dataTable = new DataSet1.HocKyDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DataSet1.HocKyDataTable dataTable) {
        ...
        public virtual int Delete(int Original_HocKyID, string Original_HocKy, global::System.Nullable<decimal> Original_HocPhi, bool Original_TrangThai) {
        ...
        public virtual int Insert(string HocKy, global::System.Nullable<decimal> HocPhi, bool TrangThai) {
            if ((HocKy == null)) {
        ...
        public virtual int Update(string HocKy, global::System.Nullable<decimal> HocPhi, bool TrangThai, int Original_HocKyID, string Original_HocKy, global::System.Nullable<decimal> Original_HocPhi, bool Original_TrangThai, int HocKyID) {
            if ((HocKy == null)) {
            ...
            this.Adapter.UpdateCommand.Parameters[9].Value = ((int)(HocKyID));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string HocKy, global::System.Nullable<decimal> HocPhi, bool TrangThai, int Original_HocKyID, string Original_HocKy, global::System.Nullable<decimal> Original_HocPhi, bool Original_TrangThai) {
